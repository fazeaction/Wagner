...
var VignettePass = require('../src/passes/vignette/VignettePass')

var scene, camera, renderer
var material, light
var cubes = []
var composer, boxBlurPass, fxaaPass, bloomPass, vignettePass
var gui
...
function animate() {
  ...
  if (params.usePostProcessing) {
    ...
    if (params.useVignette) composer.pass(vignettePass)
    composer.toScreen()
  } else {
